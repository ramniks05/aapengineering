...
@section('title', 'Services | AAP Engineerings')
        ...
        <div class="band">
            <div class="split" style="position:relative;z-index:1;align-items:center;">
                ...
                <div style="display:grid;gap:.7rem;">
                    <a href="{{ route('enquiry') }}" class="btn btn-primary">Enquiry form</a>
                    <a href="{{ route('contact') }}" class="btn btn-ghost">Contact / WhatsApp</a>
                </div>
            </div>
        </div>
    </div>
